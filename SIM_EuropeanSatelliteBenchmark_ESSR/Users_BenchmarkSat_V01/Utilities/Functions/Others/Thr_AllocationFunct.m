% function y = Thr_AllocationFunct(u)
%-------------------------------------------------------------------------
% y = Thr_AllocationFunct(u)
% This function allocates the thrust value to each thruster of a RCS given
% a specific RCS architecture and demanded force/torque vector to realize.
% INPUTS:
